...
export function DownloadButtons({ size = "base" }: { size?: "base" | "lg" }) {
  ...
  const pad = size === "lg" 
    ? "px-5 py-3.5 sm:px-6 sm:py-3.5 text-xs sm:text-sm font-extrabold" 
    : "px-4 py-2.5 sm:px-5 sm:py-3 text-xs font-bold";
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4 w-full max-w-3xl mx-auto">
      {/* Android Direct Download Button */}
      {ANDROID_DIRECT_LINK && (
        <a
          href={ANDROID_DIRECT_LINK}
          download
          className={`group relative w-full sm:w-auto flex items-center justify-center gap-2.5 ${pad} rounded-2xl text-[#050508] overflow-hidden bg-gradient-to-r from-[#FBF0CB] via-[#D4AF37] to-[#8B6914] shadow-[0_8px_30px_rgba(212,175,55,0.4)] hover:shadow-[0_12px_45px_rgba(240,217,140,0.7)] hover:-translate-y-1 active:scale-95 transition-all duration-300 border border-[#FFF5DC]/40 shrink-0`}
          style={fontStyle}
        >
          ...
          <Zap className="w-4.5 h-4.5 relative z-10 text-[#050508] transition-transform duration-300 group-hover:scale-110" strokeWidth={2.5} />
      ...
      >
        ...
        <Download className="w-4.5 h-4.5 relative z-10 text-[#050508] transition-transform duration-300 group-hover:scale-110" strokeWidth={2.5} />
      ...
      {IOS_LINK ? (
        <a
          ...
          style={fontStyle}
        >
          <Apple className="w-4.5 h-4.5 transition-transform duration-300 group-hover:scale-110 text-[#F0D78C]" />
        ...
        <button
          ...
          style={fontStyle}
        >
          <Apple className="w-4.5 h-4.5 text-[#D4AF37]/70 group-hover:text-[#F0D78C] transition-colors" />
